...
from modules.GMM import GMMParameters
...
from modules.svm import SVMParameters
...
def binary_logreg_quadratic__trainNeval(DTR: np.ndarray, LTR: np.ndarray, DVAL: np.ndarray, LVAL: np.ndarray,
    ...
    w, b, pi_emp = binary_logreg_quadratic__train(DTR, LTR, l)
    llrs, logposteriors, _ = binary_logreg_quadratic__classify(w, b, DVAL, pi_emp)
...
def classify_GMM(D: ndarray, GMM_class0_model: GMMParameters, GMM_class1_model: GMMParameters) -> ndarray:
